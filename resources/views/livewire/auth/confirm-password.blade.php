<x-layouts.auth :title="__('Confirmar contraseña • ATS Boost')">
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('password.confirm.store') }}" class="flex flex-col gap-6">
            ...
            <flux:input name="password" :label="__('Contraseña')" type="password" required autocomplete="current-password"
