<section class="w-full">
    ...
    <x-settings.layout :heading="__('Autenticación de dos factores')" :subheading="__('Administra la configuración de tu autenticación de dos factores')">
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            @if ($twoFactorEnabled)
                <div class="space-y-4">
                    ...
                    <flux:text>
                        {{ __('Con la autenticación de dos factores habilitada, se te pedirá un código aleatorio seguro durante el inicio de sesión que puedes recuperar de la aplicación compatible con TOTP en tu teléfono.') }}
                    </flux:text>
            ...
            @else
                <div class="space-y-4">
                    ...
                    <flux:text variant="subtle">
                        {{ __('Cuando habilites la autenticación de dos factores, se te pedirá un código seguro durante el inicio de sesión. Este código se puede recuperar de una aplicación compatible con TOTP en tu teléfono.') }}
                    </flux:text>
