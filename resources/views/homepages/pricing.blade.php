    ...
    <div class="space-y-6">
        <div class="space-y-3">
            ...
            <flux:subheading level="2"
                ...
                Tailor your resume with ATS-friendly optimization to stand out from the crowd,<br
                ...
                <div
                    ...
                    <flux:card class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 lg:rounded-r-none">
                        <div class="space-y-6">
                            ...
                            <flux:button class="w-full" as="link" href="{{ route('checkout', 1139077) }}" variant="filled" icon-trailing="chevron-right">
                                Try for free
                            </flux:button>
                        </div>
                    </flux:card>
                ...
                <div
                    ...
                    <flux:card class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 lg:pb-12">
                        <div class="space-y-6">
                            ...
                            <flux:button class="w-full" as="link" href="{{ route('checkout', 1139017) }}" variant="primary" icon-trailing="chevron-right">
                                Try for free
                            </flux:button>
                        </div>
                    </flux:card>
                ...
                <div
                    ...
                    <flux:card class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 lg:rounded-l-none">
                        <div class="space-y-6">
                            ...
                            <flux:button class="w-full" as="link" href="{{ route('checkout', 1139078) }}" variant="filled" icon-trailing="chevron-right">
                                Try for free
                            </flux:button>
                        </div>
                    </flux:card>
